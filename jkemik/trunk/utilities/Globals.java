...
public class Globals {
	...
	public static final Color[] CHEMIK_COLOR = { new Color(77, 192, 250),
			new Color(103, 250, 95), new Color(250, 250, 57) };
	public static final Color[] ORIGINE_COLOR = { new Color(232, 216, 37),
			new Color(99, 196, 235), new Color(45, 214, 68) };
	public static final Color[] CLASSIC_COLOR = { new Color(0, 255, 0),
			new Color(250, 50, 50), new Color(250, 250, 250) };
	public static final Color[] GEECKY_COLOR = { new Color(166, 171, 179),
			new Color(206, 156, 151), new Color(150, 196, 147) };
	...
	public static final String[] laguageNames = { "ENGLISH", "FRANCAIS",
			"DEUTSCH" };
